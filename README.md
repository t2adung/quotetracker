...
ảnh tham chiếu — để cả chuỗi ảnh giữ đúng nhân vật/bối cảnh/ánh sáng, chỉ tiến triển nhẹ qua từng
khung hình, tạo cảm giác như đang xem 1 đoạn video chuyển động khi ghép các ảnh lại theo thứ tự
quote. Dùng `--image-scope=video` nếu chỉ muốn 1 ảnh duy nhất đại diện cho cả video, áp dụng
chung cho mọi quote của video đó.
