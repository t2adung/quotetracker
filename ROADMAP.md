...
## Milestone 4b — Ghép quote thành kịch bản
Mục tiêu: sau khi các quote của 1 video đã được ghi vào tab `Quotes`, ghép nhiều quote phù hợp
(cùng 1 "STT Video nguồn") thành 1 kịch bản (script) liền mạch — có cấu trúc hook - vấn đề -
insight - câu chốt, giữ nguyên văn quote gốc, nhất quán về giọng điệu và logic — làm đầu vào cho
bước dựng video Remotion sau này (dựng 1 video hoàn chỉnh thay vì mỗi quote 1 video ngắn rời rạc).

- [ ] Có thêm tab lưu kết quả ghép script, tách biệt với tab `Quotes`
- [ ] Có bước dùng Gemini để chọn quote phù hợp trong cùng 1 video nguồn và ghép nối thành script
- [ ] Có bước tự kiểm tra lại (self-check) tính nhất quán của script trước khi ghi vào Sheet —
      script không đạt (mâu thuẫn ý, lặp ý, lệch giọng điệu) thì bỏ qua, không ghi
- [ ] Nối vào luồng chạy chính (`index.js`), chạy nối tiếp ngay sau bước ghi quote vào Sheet
- [ ] Log tiến độ rõ ràng ra console bằng tiếng Việt; 1 video lỗi hoặc ghép không đạt thì bỏ qua,
      không dừng cả vòng lặp

**Nghiệm thu**: chạy thử với 1 video đã có sẵn quote trong Sheet → ra đúng 1 dòng mới trong tab
Scripts, đọc full script thấy mạch lạc, giữ đúng câu quote gốc, không bị lặp ý hoặc mâu thuẫn.
